...
> 개정: 2026-07-14 (안승현) — **용어·코스색·viz·forced_turn 전면 정합** · Out=흰만 · In=노란우선
...
| `forced_turn` | 카메라 표지 무시 (`sign_ignored(forced=…)`) |
...
로그: `data/captures/fork_drive_logs/<stamp>/` · 캡처: `auto_fork/out_fork/verify/current.png`
